	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				-->
			<li class="active"><a id="event_history" onclick="load(this.id)"><em class="fa fa-calendar">&nbsp;</em> Events History</a></li>
			<li><a id="create_event" onclick="load(this.id)"  ><em class="fa fa-calendar">&nbsp;</em> Create Event </a></li>
