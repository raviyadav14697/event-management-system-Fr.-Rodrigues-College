...
<head>
  ...
  <script defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA5_6sxC1c-_4f-cqyAbfha-2YixSjh51Y">
  </script>
  <script type="text/javascript" src="js/upcoming_event.js"></script>
...
<div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Nearby Event Locations</h1>
      </div>
    </div><!--/.row-->

<div style="border: 3px solid blue" id="map"></div>
