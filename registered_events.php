  ...
  <div  class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
      <ol class="breadcrumb">
        ...
        <li class="active">Registered Events</li>
      </ol>
    </div><!--/.row-->
    
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Registered Events</h1>
      </div>
    </div><!--/.row-->
...
<div class="row ravi">
    ...
    <div class="card col-md-4" >
      <img class="card-img-top" style="width: 300px; height: 300px;" src="<?php echo $a[0] ?>" alt="Card image cap">
      <div class="card-body">
    ...
    <div class="card col-md-4">
      <img class="card-img-top" style="width: 300px; height: 300px;" src="<?php echo $a[1] ?>" alt="Card image cap">
      <div class="card-body">
    ...
    <div class="card col-md-4" >
      <img class="card-img-top" style="width: 300px; height: 300px;" src="<?php echo $a[2] ?>" alt="Card image cap">
      <div class="card-body">
        <h1 class="card-title"><?php echo $name[2]; ?></h1>
        <p class="card-text"><?php echo $date[2]; ?></p>
