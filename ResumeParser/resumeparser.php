            ...
            if (move_uploaded_file($fileToUpload['tmp_name'], $target_file)) {
                ...
                foreach ($fileInfo as $row) {
                    ...
                    // echo $part.'<br><br>';
                        ...
                        preg_match_all('/production|sales|call center|Accounts|marketting|tele communication|engineer|Java|PHP|JavaScript| HTML5|C|MySQL|software engineering|software engineer|manufacturing|office administration|human resource|admin|secretarial|customer service|call center|finance account/', $resumeText, $matches);
                        if (count($matches[0])) {
...
<body>
    ...
    ?>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" name="resumeskills">
                                                <?php 
