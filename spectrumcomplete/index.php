...
<div class="container">
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-4">
				<a href="index.php"><img src="SpectrumAcademy.jpg" width="100px" height="100px" alt="Spectrum Academy"></a>
			</div>
