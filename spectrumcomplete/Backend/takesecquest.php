	...
	<div class="container">
		...
		<form class="form-horizontal well" method="POST" action="verifysecquest.php" role="form">
			<div class="form-group">
				<label class="control-label col-sm-3" for="username">Username (min 5 characters):</label>
				<div class="col-sm-9">
					<input type="text"  name="username" class="form-control" required></input>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3" for="oldpwd">Password (min 5 characters):</label>
				<div class="col-sm-9">
